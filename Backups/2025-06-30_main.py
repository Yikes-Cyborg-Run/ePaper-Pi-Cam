<<<<<<< HEAD:Backups/2025-06-30_main.py
<<<<<<< HEAD
# MAIN BRANCH
...
>>>>>>> 405e795fe7aaf316c2d1ef557e105ecf48a6d663:main.py
from gpiozero import LED, Button
from picamzero import Camera
from pathlib import Path
...
class Action():
	...
	def take_photo(self, cam, photo_list):
		...
		if str(self.config['blackwhitephotos'])=="Black & White": cam.greyscale=True
...
def main():
	...
	cam=Camera()
	size=cam.still_size
	logger.info(f"Photo resolution set to: {size}.")
	# Create a list of existing photos
	photo_list=Action().photo_list() 
