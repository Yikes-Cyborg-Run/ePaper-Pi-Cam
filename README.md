...
This code only supports [Waveshare ePaper displays](https://www.waveshare.com/epaper). It is written mostly for the [Waveshare HAT that includes GPIO buttons](https://www.waveshare.com/product/displays/e-paper/epaper-2/2.7inch-e-paper-hat.htm?___SID=U). The fact that the HAT has GPIO buttons built in makes it very convenient and easy to use. However, you can use any of the displays listed in the [waveshare_epd](https://github.com/Yikes-Cyborg-Run/ePaper-Pi-Cam/tree/main/waveshare_epd) directory. You will need to edit the code to use your specific display. Open the file "eppc.py" and look for this code at the top: `from waveshare_epd import epd2in7_V2`. Edit this code to match your specific display. Then in the Display class, change the code `self.epd=epd2in7_V2.EPD()` to match your display. 
